...
video_extension_list   = [ '.mp4 (x264)']
interpolation_list     = [ 'Low']
AI_precision_list      = [ 'Full precision' ]
AI_multithreading_list = [ 'Disabled']
...
def place_output_path_textbox():
    ...
    select_output_path_button.place(relx = column2_x, rely  = row0_y - 0.06, anchor = "center")
...
def place_message_label():
    ...
    message_label.place(relx = column2_x, rely = row2_y - 0.075, anchor = "center")
...
def place_upscale_button(): 
    ...
    upscale_button.place(relx = column2_x, rely = row2_y, anchor = "center")
...
class App():
    def __init__(self, window):
        ...
        window.iconbitmap(find_by_relative_path("Assets" + os_separator + "upscale_icon.png"))
